<div class="kt-portlet kt-portlet--collapse" data-ktportlet="true">
    ...
    <div class="kt-portlet__body" style="display: none; overflow: hidden; padding-top: 0; padding-bottom: 0;">
        <form class="kt-form kt-form--label-right" action="{{$update_url}}" method="post">
            ...
            <input type="hidden" name="key" value="tool"/>
                ...
                <div class="kt-section__content">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input class="form-control js-picker" name="preference[colors][]" type="text"
                                              style="{{'border-color:' . ($preference['colors'][0] ?? '#435e70')  . ';'}}"></label>
                            </td>
                            <th class=""><label>2</label></th>
                            <td>
                                <label><input class="form-control js-picker" name="preference[colors][]" type="text"
                                              style="{{'border-color:' . ($preference['colors'][1] ?? '#435e70')  . ';'}}"></label>
                            </td>
                            <th class=""><label>3</label></th>
                            <td>
                                <label><input class="form-control js-picker" name="preference[colors][]" type="text"
                                              style="{{'border-color:' . ($preference['colors'][2] ?? '#435e70')  . ';'}}"></label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <label><input class="form-control js-picker" name="preference[colors][]" type="text"
                                              style="{{'border-color:' . ($preference['colors'][3] ?? '#435e70')  . ';'}}"></label>
                            </td>
                            <th class=""><label>5</label></th>
                            <td>
                                <label><input class="form-control js-picker" name="preference[colors][]" type="text"
                                              style="{{'border-color:' . ($preference['colors'][4] ?? '#435e70')  . ';'}}"></label>
                            </td>
                            <th class=""><label>6</label></th>
                            <td>
                                <label><input class="form-control js-picker" name="preference[colors][]" type="text"
                                              style="{{'border-color:' . ($preference['colors'][5] ?? '#435e70')  . ';'}}"></label>
                            </td>
                        </tr>
                        </tbody>
                    </table>
