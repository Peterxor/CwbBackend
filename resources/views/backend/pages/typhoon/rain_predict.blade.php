                            ...
                            <div class="kt-section kt-section--first">
                                <div class="form-group row">
                                    <label for="example-search-input" class="col-3 col-form-label">
                                        <span class="kt-font-danger">*</span>總雨量預測資料來源 (xml)
                                    </label>
                                    <div class="col-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        <input class="form-control" type="text" value="{{$json->info->alert_value}}" name="info-alert_value" required>
                                    </div>
                                    <div class="col-3 pt-3 col-form-label">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-search-input" class="col-3 col-form-label">
                                        <span class="kt-font-danger">*</span>24h雨量預測資料來源 (xml)
                                    </label>
                                    <div class="col-6">
                                        <input class="form-control" type="text" value="{{$json->info->origin24}}" name="info-origin24" required>
                                    </div>
                                    <div class="col-3 pt-3 col-form-label">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        <input class="form-control" type="text" value="{{$json->info->alert_value_24}}" name="info-alert_value_24" required>
                                    </div>
                                    <div class="col-3 pt-3 col-form-label">
                                    </div>
                                </div>
