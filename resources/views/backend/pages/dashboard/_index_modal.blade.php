<div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="" style="display: none;"
     aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                        id="editModal-top-cancel-btn">
                </button>
            </div>
            <div class="modal-body">
                <input type="hidden" name="board_id" id="board_id" value="">
                <input type="hidden" name="board_device_id" id="board_device_id" value="">
                <form class="kt-form" id="edit-form">
                    <div class="form-group row">
                        <div class="col-12 kt-align-center" style="background-color:#efefef">
                            <label id="label-title" for="example-search-input" class="col-form-label">
                                裝置：多螢幕輸出（21:9）
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-9">
                            <div class="kt-radio-inline">
                                <label class="kt-radio">
                                    <input class="mr-1" type="radio" id="edition_1" name="edition_type"
                                           value="default"/>預設版型
                                    <span></span>
                                </label>
                                <label class="kt-radio">
                                    <input class="mr-1" type="radio" id="edition_2" name="edition_type" value="upload"/>上傳圖片
                                    <span></span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="js-display-block js-default" style="display:none;">
                        <div class="form-group row">
                            <div class="col-3 kt-align-right">
                                <label for="example-search-input" class="col-form-label">
                                    背景
                            ...
                            <div class="col-5">
                                <select class="form-control" name="board_background">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control js-news" name="news_time" id="news-time"
                                           disabled data-format="hh:mm">
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-5">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="la la-clock-o"></i></span></div>
                                    <input type="text" class="form-control js-news" name="next_news_time"
                                           id="next-news-time"
                                           disabled data-format="hh:mm">
                                </div>
                            </div>
                    ...
                    <div class="js-display-block js-upload" style="display:none;">
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <div class="col-3">
                                    <label for="board_image" class="custom-file-upload">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" id="editModal-cancel-btn">取消
                </button>
