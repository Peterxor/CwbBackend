...
<form class="kt-form kt-form--label-right" id="add-info-form" action="{{route('personnel.store', [])}}" method="post" enctype="multipart/form-data">
  @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-3 kt-input-icon">
                        <input class="form-control"
                               type="text"
                               value="" name="name" required placeholder="請輸入人員姓名">
