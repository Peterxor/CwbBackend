                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section kt-section--first">
                    			...
                    			<div class="col-7">
                                    <div class="kt-radio-inline">
                    					<label class="kt-radio">
                    						<input class="mr-1" type="radio" name="display_type" value="1" id="single" />單圖
                                            <span></span>
                    					</label>
                    					<label class="kt-radio">
                    						<input class="ml-2 mr-1" type="radio" name="display_type" value="2" id="parallel" />雙圖並列
                                            <span></span>
                    					</label>
                                        <label class="kt-radio">
                    						<input class="ml-2 mr-1" type="radio" name="display_type" value="3" id="dynamic" />動態組圖
                                            <span></span>
                    					</label>
                                        <label class="kt-radio">
                    						<input class="ml-2 mr-1" type="radio" name="display_type" value="4" id="list" />圖片列表
                                            <span></span>
                    					</label>
                    				</div>
                                </div>
                            ...
                            <div class="form-group row js-info-group js-single js-dynamic js-list" style="display:none;">
                    			<label for="example-search-input" class="col-2 col-form-label">
                            ...
                            <div class="form-group row js-info-group js-parallel" style="display:none;">
                    			<label for="example-search-input" class="col-2 col-form-label">
                            ...
                            <div class="form-group row js-parallel" style="display:none;">
                    			<label for="example-search-input" class="col-2 col-form-label">
                            ...
                            <div class="form-group row js-info-group js-dynamic" style="display:none;">
                    			<label for="example-search-input" class="col-2 col-form-label">
