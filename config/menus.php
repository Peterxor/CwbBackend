...
return array(
    ['name' => '', 'permission'=>'', 'display_name' => 'Dashboard', 'link' => 'index', 'display' => true , 'level'=>'1', 'icon'=>'<i class="la la-dashboard"></i>'],
    ...
    ['name' => 'media', 'permission'=>'', 'display_name' => '圖資管理', 'display' => true, 'level'=>'1', 'icon'=>'','children' => [
        ['name' => 'weather', 'permission'=>'', 'display_name' => '一般天氣預報圖資', 'link' => 'weather.index', 'display' => false, 'level'=>'2'],
