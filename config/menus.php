...
return array(
    ...
    ['name' => 'media', 'permission'=>'', 'display_name' => '圖資管理', 'display' => true, 'level'=>'1', 'icon'=>'','children' => [
        ['name' => 'weather', 'permission'=>'', 'display_name' => '一般天氣預報圖資', 'link' => 'weather.index', 'display' => true, 'level'=>'2'],
        ['name' => 'typhoon', 'permission'=>'', 'display_name' => '颱風預報圖資', 'link' => 'typhoon.index', 'display' => true, 'level'=>'2'],
    ]],
